...
const Header = (props:Props)=>{
  const user:any = AsyncStorageService.getUser();
    ...
    <a href="/" className="logo">
      ...
      <span className="logo-lg"><b>Nano</b>Network</span>
    </a>
      ...
      <div className="navbar-custom-menu">
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown user user-menu">
            <a href="#" className="dropdown-toggle" data-toggle="dropdown">
              <img src="/logo.jpeg" className="user-image" alt="User Image"/>
              {/* <i className="fa fa-user"></i> */}

              <span className="hidden-xs" style={{textTransform:'capitalize'}}>{user?.userName ? (user?.userName) : ('Alexander Pierce')}</span>
            </a>
            <ul className="dropdown-menu">
